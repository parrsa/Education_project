...
const Comment = () => {
  ...
  <div class="max-w-2xl mx-auto px-4">
    ...
    <form class="mb-6">
        ...
        <button type="submit"
            class="inline-flex absolute items-center py-2.5 px-4 text-xs bg-red-7004 font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
            ارسال
        </button>
    </form>
